                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body" id="info">
                            ...
                            @endphp
                            <div class="alert @if(!$razlika) alert-danger @else alert-info @endif alert-dismissible"
                                 role="alert">
                                <div class="d-flex">
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted">@if(!$razlika) Остало је још {{$razlika_sati}} сати и
                                            {{$razlika_minuti}} минута за активност <em>{{$akt->naziv}}</em>
                                            @else{{$akt->naziv}} је у току и траје до {{$datum->format('d.m.Y.
                                            H:i')}}@endif
                                        </div>
                                    </div>
                                </div>
                                <a href="javascript:;" class="btn-close" data-bs-dismiss="alert" aria-label="close"
                                   onclick="checkEmptyDiv()"></a>
                            </div>
