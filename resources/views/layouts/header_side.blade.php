...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{asset('static/school.svg')}}">
  ...
  <body >
    ...
    <div class="page page-center" id="spinner">
      <div class="container container-slim py-4">
        <div class="text-center">
          <div class="mb-3">
            <a href="." class="navbar-brand navbar-brand-autodark"><img src="{{asset('static/logo-small.svg')}}" height="36" alt=""></a>
          </div>
          <div class="text-muted mb-3">Припрема апликације</div>
      ...
      <aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
        <div class="container-fluid">
          ...
          <h1 class="navbar-brand">
            <a href="{{route('home')}}">
              <img src="{{asset('static/logo-etf-meni-levi-gore.png')}}" width="110" height="32" alt="Tabler" class="navbar-brand-image"><strong>ЕТФ</strong>
            </a>
          </h1>
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user-circle avatar avatar-sm" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ff2825" fill="none" stroke-linecap="round" stroke-linejoin="round">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                <a href="{{route('profil')}}" class="dropdown-item">Профил</a>
                <a href="./settings.html" class="dropdown-item">Подешавања</a>
                <div class="dropdown-divider"></div>
                
                <a href="{{route('logout')}}" class="dropdown-item">Одјава</a>
              </div>
            </div>
          </div>
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{route('rokovi')}}" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
             ...
             <li class="nav-item">
              <a class="nav-link" href="{{route('prijava_ispita')}}" >
                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                ...
                <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-checklist" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M9.615 20h-2.615a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v8"></path><path d="M14 19l2 2l4 -4"></path><path d="M9 8h4"></path><path d="M9 12h2"></path>
                   </svg>
                  </span>
                  <span class="nav-link-title">
                    Испити
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a href="{{route('ispiti.polozeni')}}" class="dropdown-item">
                        Положени испити
                      </a>
                      <a href="#" class="dropdown-item">
                        Еквивалентирани испити
                      </a>
                      <a href="{{route('ispiti.neuspesna')}}" class="dropdown-item">
                        Неуспешна полагања
                      </a>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      @if(App\Models\OrganizacionaAktivnost::uToku('Бирање предмета'))
                      <a href="{{route('predmeti_izbor')}}" class="dropdown-item">
                        Бирање предмета 
                      </a>
                      @endif
                      <a href="{{route('predmeti_tekuca')}}" class="dropdown-item">
                        Предмети <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">{{App\Models\SkolskaGodina::tekuca()->naziv}}</span>
                      </a>
                      <a href="{{route('predmeti')}}" class="dropdown-item">
                        Сви предмети
                      </a>
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{route('stud.rasp_cas')}}" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
             ...
             <li class="nav-item">
              <a class="nav-link" href="{{route('zap.angazovanje')}}" >
                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-pencil" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M4 20h4l10.5 -10.5a1.5 1.5 0 0 0 -4 -4l-10.5 10.5v4"></path>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('zap.dezurstva')}}" >
                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
          ...
          <div class="navbar-nav flex-row order-md-last">
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                @php $id_calc = Auth::user()->id*37+17; @endphp 
                @if(Auth::user()->isStudent())
                <a href="{{route('profil')}}" class="dropdown-item">Профил</a>
                @else
                <a href="{{route('zap.profil', Auth::user()->ime."-".Auth::user()->prezime."-".$id_calc)}}" class="dropdown-item">Профил</a>
                @endif
                <a href="./settings.html" class="dropdown-item">Подешавања</a>
                <div class="dropdown-divider"></div>
...
boxes.forEach(box => {
  ...
  <script>
    ...
    if (!div.classList.contains("theme-dark"))
{
  Swal.fire({
  title: 'Дошло је до грешке!',
  html: '<?php echo($errors->first()); ?>',
  icon: 'error',
