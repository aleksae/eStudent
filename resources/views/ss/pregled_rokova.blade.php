            ...
            <div class="card">
              <div class="card-body">
                  ...
                  <table class="table table-striped table-hover table-fit">
                    ...
                    <tbody class="table-tbody">
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#" class="me-2">Уреди</a>
                          <a class="me-2" href="#">
                            <span onclick="prikazSvi({{$rok->id}})">Прегледај испите у року</span>
                          </a>
                          <a class="" href="{{route('ss.dodavanje_u_rok', $rok->id)}}">
                            Додај нов испит у рок
                          </href=>
                        </td>
                ...
                <div id="svi-{{$rok->id}}" class="rokovi-svi">
                  @if(count( $ispiti->where('id_roka', $rok->id)))
                  ...
                  <div id="table-default" class="table-responsive">
                      <table class="table table-striped table-hover table-fit">
                        ...
                        <tbody class="table-tbody">
                          ...
                          @endforeach
                          @foreach($ispiti_spojeno_detalji as $key=>$val)
                                
                                
                                    @php $prom = $ispiti_spojeno->where('id_rok', $rok->id)->where('id_pred_gr', $key)->first(); @endphp
                                    @if($prom)
                                      <tr>
                                        <td class="sort-sifra-{{$rok->id}}-moji"><a href="#">{{$prom->sifra_predmeta}}</a></td>
                    ...
                    @else <h4 class="text-warning">Нема испита за изабрани рок.</h4> @endif
                  </div>
