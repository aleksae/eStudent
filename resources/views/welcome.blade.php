...
<html lang="en">
  <head>
    ...
    <title>еСтудент</title>
    <link rel="icon" href="./static/school.svg">
    <!-- CSS files -->
      ...
      <aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
        <div class="container-fluid">
          ...
          <h1 class="navbar-brand">
            <a href=".">
              <img src="./static/logo-etf-meni-levi-gore.png" width="110" height="32" alt="Tabler" class="navbar-brand-image"><strong>ЕТФ</strong>
            </a>
          </h1>
            ...
            <div class="row row-deck row-cards">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Просек</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Текући семестар</a>
                          <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item active" href="#">Текући семестар</a>
                            <a class="dropdown-item" href="#">Текућа година</a>
                            <a class="dropdown-item" href="#">Студије</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="h1 mb-3">8,84</div>
                    ...
                    <div class="progress progress-sm">
                      <div class="progress-bar bg-primary" style="width: 88.4%" role="progressbar" aria-valuenow="88.4" aria-valuemin="0" aria-valuemax="100" aria-label="88,4%">
                        <span class="visually-hidden">88,4%</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Стање на рачуну</div>
                      <div class="ms-auto lh-1">
                        
                      </div>
                    </div>
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-0 me-2">2000,00</div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Број положених испита</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                          <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item active" href="#">Последњих 7 дана</a>
                            <a class="dropdown-item" href="#">Последњих 30 дана</a>
                            <a class="dropdown-item" href="#">Одувек</a>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
      	window.ApexCharts && (new ApexCharts(document.getElementById('chart-revenue-bg'), {
      		...
      		series: [{
      			name: "Износ",
      			data: [0, 0, 0, 2000, 1000, 0, 0, 0, 0, 2000]
      		}],
      		tooltip: {
      			theme: 'dark'
      		},
      		...
      		labels: [
      			'2023-03-01','2023-04-01','2023-05-01','2023-06-01', '2023-07-01', '2023-08-01', '2023-09-01','2023-10-01','2023-11-01','2023-12-01'
      		],
